...
-------
    export BSD_KEY='...'
    python3 bouw_euromatches_v1.2.py              # schrijft euromatches.json
    python3 bouw_euromatches_v1.2.py --toon       # print ook de lijst
...
def main():
    ...
    print('=' * 66)
    print('bouw_euromatches v1.2 - CL, EL en Conference League')
