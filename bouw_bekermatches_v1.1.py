...
GEBRUIK
-------
    python3 bouw_bekermatches_v1.1.py              # lokaal, schrijft alleen
    python3 bouw_bekermatches_v1.1.py --push       # pusht naar de repo
    python3 bouw_bekermatches_v1.1.py --toon       # print de gevonden lijst
"""
...
def main():
    ...
    print('=' * 62)
    print('bouw_bekermatches v1.1 - Croky Cup')
